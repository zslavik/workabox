...
class GoodsDebit
{
                ...
                case 5:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i704 = 0; $_i704 < $_size700; ++$_i704) {
                            $elem705 = null;
                            $elem705 = new \Workabox\API\GoodsInMoveLine();
                            $xfer += $elem705->read($input);
                            $this->GoodsInMove []= $elem705;
                        }
                ...
                case 10:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i710 = 0; $_i710 < $_size706; ++$_i710) {
                            $elem711 = null;
                            $elem711 = new \Workabox\API\OuterCodesLine();
                            $xfer += $elem711->read($input);
                            $this->OuterCodes []= $elem711;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->GoodsInMove !== null) {
            ...
            foreach ($this->GoodsInMove as $iter712) {
        ...
        if ($this->OuterCodes !== null) {
            ...
            foreach ($this->OuterCodes as $iter713) {
