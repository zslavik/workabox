...
class GoodsReturn
{
                ...
                case 6:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i683 = 0; $_i683 < $_size679; ++$_i683) {
                            $elem684 = null;
                            $elem684 = new \Workabox\API\GoodsInMoveLine();
                            $xfer += $elem684->read($input);
                            $this->GoodsInMove []= $elem684;
                        }
                ...
                case 11:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i689 = 0; $_i689 < $_size685; ++$_i689) {
                            $elem690 = null;
                            $elem690 = new \Workabox\API\OuterCodesLine();
                            $xfer += $elem690->read($input);
                            $this->OuterCodes []= $elem690;
                        }
                        $xfer += $input->readListEnd();
                    } else {
                        $xfer += $input->skip($ftype);
    ...
    public function write($output)
    {
        ...
        if ($this->GoodsInMove !== null) {
            ...
            foreach ($this->GoodsInMove as $iter691) {
        ...
        if ($this->OuterCodes !== null) {
            ...
            foreach ($this->OuterCodes as $iter692) {
